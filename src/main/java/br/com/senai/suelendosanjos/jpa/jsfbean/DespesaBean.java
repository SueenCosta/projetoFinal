...
public class DespesaBean {
	...
	@PersistenceContext //FUNCIONA COMO CONTAINER QUE GUARDA AS ENTIDADES QUE ESTAO SENDO GERENCIADAS PELO ENTITYMANAGER, ELE FUNCIONA COMO O CACHEL.
	...
	public List<Despesas> listar() {
		return em.createQuery("SELECT c FROM Cliente c", Despesas.class).getResultList(); // O EM.CREATE PARA OBTER LISTA DE REGISTRO A PARTIR DE UMA TABELA DO BANCO DE DADOS.
	}
